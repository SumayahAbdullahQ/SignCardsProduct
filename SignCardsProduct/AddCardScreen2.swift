...
class CardStore2: ObservableObject {
    @Published var cards2: [Card2] = []
}

struct AddCardScreen2: View {
        ...
        VStack {
            HStack {
                ...
                Button {
                    ...
                    let newCard2 = Card2(color: cardColor, description: "\(emojiInput)\n\n\(cardDescription)") // Adding a new line
                    cardStore2.cards2.append(newCard2)
