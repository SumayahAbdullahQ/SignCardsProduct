...
class CardStore4: ObservableObject {
    @Published var cards4: [Card4] = []
}
import SwiftUI

struct AddCardScreen4: View {
        ...
        VStack {
            HStack {
                ...
                Button {
                    ...
                    let newCard4 = Card4(color: cardColor, description: "\(emojiInput)\n\n\(cardDescription)") // Adding a new line
                    cardStore4.cards4.append(newCard4)
